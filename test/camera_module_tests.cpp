...
TEST_F(CameraModuleTest, PrimaryCameraManagement) {
    ...
    rrl::ObjectID cam1 = engine->camera.SpawnCamera(rrl::camera::PerspectiveModel{}, rrl::camera::CameraViewBasis::STANDARD_OPENGL, rrl::rhi::TARGET_MAIN);
    rrl::ObjectID cam2 = engine->camera.SpawnCamera(rrl::camera::PerspectiveModel{}, rrl::camera::CameraViewBasis::STANDARD_OPENGL, rrl::rhi::RESOURCE_NULL);
