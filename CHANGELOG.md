...
## [1.0.0] - 2026-06-10
### Added
- Unified `rrl::Engine` OOP Facade encapsulating all engine modules and completely hiding ECS/EnTT internals from the public API.
...
- Native `RRL::Asset` Garbage Collection with `CASCADE_DELETE` policies.
...
### Changed
- Decoupled `MaterialAsset` from `MeshAsset` to allow independent multi-material instantiating.
