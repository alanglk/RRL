 ...
 *  This is used by the automatic camera system to adapt projection matrices to the 
...
/**
 * @brief This tells the camera model what is the camera coordinate system. 
 * This is used by the automatic camera system to adapt the view matrices 
 *  aplying the appropiate tf correction.
 */
enum class CameraViewBasis {
    STANDARD_OPENGL,    // -Z forward, +Y up (Default)
    STANDARD_OPENCV     // +Z forward, +Y down (NuScenes / ROS / OpenCV)
};
